...
let add_to_operator_set op_string operator_set =
  match op_string with
      "not"   -> {op1 = Not :: operator_set.op1; op2 = operator_set.op2; if0 = operator_set.if0; fold = operator_set.fold; tfold = operator_set.tfold}
    | "shl1"  -> {op1 = Shl1 :: operator_set.op1; op2 = operator_set.op2; if0 = operator_set.if0; fold = operator_set.fold; tfold = operator_set.tfold}
    | "shr1"  -> {op1 = Shr1 :: operator_set.op1; op2 = operator_set.op2; if0 = operator_set.if0; fold = operator_set.fold; tfold = operator_set.tfold}
    | "shr4"  -> {op1 = Shr4 :: operator_set.op1; op2 = operator_set.op2; if0 = operator_set.if0; fold = operator_set.fold; tfold = operator_set.tfold}
    | "shr16" -> {op1 = Shr16 :: operator_set.op1; op2 = operator_set.op2; if0 = operator_set.if0; fold = operator_set.fold; tfold = operator_set.tfold}
    | "and"   -> {op1 = operator_set.op1; op2 = And :: operator_set.op2; if0 = operator_set.if0; fold = operator_set.fold; tfold = operator_set.tfold}
    | "or"    -> {op1 = operator_set.op1; op2 = Or :: operator_set.op2; if0 = operator_set.if0; fold = operator_set.fold; tfold = operator_set.tfold}
    | "xor"   -> {op1 = operator_set.op1; op2 = Xor :: operator_set.op2; if0 = operator_set.if0; fold = operator_set.fold; tfold = operator_set.tfold}
    | "plus"  -> {op1 = operator_set.op1; op2 = Plus :: operator_set.op2; if0 = operator_set.if0; fold = operator_set.fold; tfold = operator_set.tfold}
    | "if0"  -> {op1 = operator_set.op1; op2 = operator_set.op2; if0 = true; fold = operator_set.fold; tfold = operator_set.tfold}
    | "fold"  -> {op1 = operator_set.op1; op2 = operator_set.op2; if0 = operator_set.if0; fold = true; tfold = operator_set.tfold}
    | "tfold"  -> {op1 = operator_set.op1; op2 = operator_set.op2; if0 = operator_set.if0; fold = operator_set.fold; tfold = true}
...
let parse_problem_property_list prop_list =
  let rec iter specs property =
    match (parse_problem_property property) with
      ...
      | None -> specs in
  List.fold_left iter {id = "-1"; size = -1; operators = empty_operator_set} prop_list
;;
